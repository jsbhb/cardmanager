	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<table class="table table-bordered">
				...
				<tr>
					<td><label>规则名称:</label></td><td><input type='text' class="form-control" id="name" name="name"></td>	 
					<td><label>规则(例：2..或者HH:MM:SS(16:30:00)):</label></td><td><input type='text' class="form-control" id="rule" name="rule"></td>	 
				</tr>
			</table>
		</form>
	</div>
...
function submitForm() {
	...
	$.ajax({
		 url:"${wmsUrl}/admin/statistic/rule/saveRule.shtml",
		 type:'post',
