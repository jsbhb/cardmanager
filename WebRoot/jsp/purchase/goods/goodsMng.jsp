...
<body>
		...
		<section class="content">
	        <div class="box box-primary">
				...
				<ul id="navTab" class="nav nav-tabs">
					<li class="active"><a id="list"  href="${wmsUrl}/admin/purchase/goodsMng/goodsList.shtml">商品上架</a></li>
				</ul>
				</div>
				<div class="box-body">
					<div id="page-wrapper">
	...
	<script type="text/javascript">
		$(function(){
			...
			newIframeObject.src = "${wmsUrl}/admin/purchase/goodsMng/goodsList.shtml";
