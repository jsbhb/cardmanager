		...
		<section class="content">
	        <div class="box box-primary">
				...
				<ul id="navTab" class="nav nav-tabs">
					<li class="active"><a id="list"  href="${wmsUrl}/admin/goods/goodsMng/list.shtml">商品列表</a></li>
					<li><a href="${wmsUrl}/admin/goods/goodsMng/toAdd.shtml?type=normal">新增商品</a></li>
					<li><a href="${wmsUrl}/admin/goods/goodsMng/syncGoods.shtml">同步商品</a></li>
				</ul>
				</div>
				<div class="box-body">
					<div id="page-wrapper">
