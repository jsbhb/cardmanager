...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-bookmark fa-fw"></i>修改包材信息</li>
						</ol>
					</div>
				</div>
				<div class="row">
	...
	<script type="text/javascript">
		...
		function getselect() {
			...
			$("#packageLength").val('${packageList.packageLength}');
			$("#packageWidth").val('${packageList.packageWidth}');
			$("#packageHeight").val('${packageList.packageHeight}');
			$("#packageWeight").val('${packageList.packageWeight}');
			$("#remark").val('${packageList.remark}');
		}
	</script>
</body>
</html>
