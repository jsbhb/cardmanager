...
<body>
	<section class="content-wrapper">
		...
		<section class="content">
			<div class="list-tabBar">
				<ul>
					<li class="active" data-url="${wmsUrl}/admin/mall/indexMng/modelInfo.shtml?pageId=7">小程序楼层设置</li>
				</ul>
			</div>
			<div class="box-body">
				<div id="page-wrapper">
	...
	<script type="text/javascript">
		$(function(){
			...
			newIframeObject.src = "${wmsUrl}/admin/mall/indexMng/modelInfo.shtml?pageId=7";
