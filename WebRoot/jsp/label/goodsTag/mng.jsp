...
<body>
	<section class="content-wrapper">
		<section class="content-header">
	      <h1><i class="fa fa-street-view"></i>标签管理</h1>
	      <ol class="breadcrumb">
		...
		<section class="content">
	        <div class="box box-primary">
				...
				<ul id="navTab" class="nav nav-tabs">
					<li class="active"><a id="list"  href="${wmsUrl}/admin/label/goodsTagMng/list.shtml">商品标签</a></li>
				</ul>
				</div>
				<div class="box-body">
					<div id="page-wrapper">
	...
	<script type="text/javascript">
		$(function(){
			...
			newIframeObject.src = "${wmsUrl}/admin/label/goodsTagMng/list.shtml";
