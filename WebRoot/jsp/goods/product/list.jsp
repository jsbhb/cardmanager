...
<section class="content-wrapper query">
	...
	<section class="content">
		...
		<div class="list-tabBar">
			<ul>				
				<li data-id="first" class="active">仓库中</li>
				<li data-id="second">待审核</li>
				<li data-id="third">审核失败</li>
				<li data-id="fourth">审核通过</li>
			</ul>
		</div>
...
var options = {
	queryForm : ".query",
	url :  "${wmsUrl}/admin/goods/listMng/dataList.shtml",
	numPerPage:"10",
	currentPage:"",
	index:"1",
