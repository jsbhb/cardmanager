		...
		<form class="form-horizontal" role="form" id="itemForm">
            ...
            <input type="hidden" class="form-control" name="itemStatus" id="itemStatus" value="${goodsInfo.goods.items[0].status}"/>
	      	<div class="list-item">
				...
				<div class="col-sm-9 item-right">
               		<input type="text" class="form-control" name="goodsName" id="goodsName" value="${goodsInfo.goods.goodsName}" readonly/>
				</div>
			</div>
	       	<div class="list-item">
			...
			<div class="list-item">
	      	...
	      	<div class="list-item">
				...
				<div class="col-sm-9 item-right">
	                 <input type="text" class="form-control" name="origin" value="${goodsInfo.goods.origin}" readonly/>
				</div>
			</div>
	      	<div class="list-item">
				<div class="col-sm-3 item-left">商品权重</div>
				<div class="col-sm-9 item-right">
	                 <input type="text" class="form-control" name="goodsTagRatio" value="${goodsInfo.goods.goodsTagRatio}" readonly>
				</div>
			</div>
			<div class="list-item">
							...
							<div class="list-all-parent">
								<div class="list-all-item list-all-item-key">
									...
									<div class="item-right">
										<div class="select-item">
											<select class="form-control select-key" onchange="changeSpecsValueInfo(this)" disabled>
								...
								<div class="list-all-item">
									...
									<div class="item-right item-value">
										<div class="select-item">
											<select class="form-control select-value" disabled>
												<c:forEach var="sp" items="${specs}">
			...
			<div id="noSpecs" style="padding:0 20px;">
				<div class="list-item" style="width:100%;">
					...
					<div class="col-sm-9 item-right">
	             		<input type="text" class="form-control" name="itemCode" id="itemCode" value="${goodsInfo.goods.items[0].itemCode}" readonly>
						<div class="item-content">
			             	（货主管理货物的编码）
			            </div>
					</div>
		       	...
		       	<div class="list-item">
					...
					<div class="col-sm-9 item-right">
	               		<input type="text" class="form-control" name="sku" id="sku" value="${goodsInfo.goods.items[0].sku}" readonly>
						<div class="item-content">
			             	（自行管理货物的编码或商家编码）
			            </div>
					</div>
		       	...
		       	<div class="list-item">
					...
					<div class="col-sm-9 item-right">
	               		<input type="text" class="form-control" name="encode" id="encode" value="${goodsInfo.goods.items[0].encode}" readonly>
						<div class="item-content">
			             	（商品自带的条形码）
			            </div>
					</div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
		                <input type="text" class="form-control" name="weight" id="weight" value="${goodsInfo.goods.items[0].weight}" readonly>
						<div class="item-content">
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
		                <input type="text" class="form-control" name="conversion" id="conversion" value="${goodsInfo.goods.items[0].conversion}" readonly>
						<div class="item-content">
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
						<input type="text" class="form-control" name="exciseTax" id="exciseTax" value="${goodsInfo.goods.items[0].exciseTax}" readonly>
						<div class="item-content">
			             	（请按小数格式输入，例：0.17）
			            </div>
		            </div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
		                <input type="text" class="form-control" name="shelfLife" id="shelfLife" value="${goodsInfo.goods.items[0].shelfLife}" readonly>
						<div class="item-content">
							（商品的保质期，例：2年，18个月）
			            </div>
					</div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
		                <input type="text" class="form-control" name="carTon" id="carTon" value="${goodsInfo.goods.items[0].carTon}" readonly>
						<div class="item-content">
							（例：8组，24罐）
			            </div>
					</div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
		                <input type="text" class="form-control" name="proxyPrice" id="proxyPrice" value="${goodsInfo.goods.items[0].goodsPrice.proxyPrice}" readonly>
		                <div class="item-content">
			             	（请按价格格式输入，例：113.35）
			            </div>
					</div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
						<input type="text" class="form-control" name="fxPrice" id="fxPrice" value="${goodsInfo.goods.items[0].goodsPrice.fxPrice}" readonly>
						<div class="item-content">
			             	（请按价格格式输入，例：113.35）
			            </div>
					</div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
						<input type="text" class="form-control" name="retailPrice" id="retailPrice" value="${goodsInfo.goods.items[0].goodsPrice.retailPrice}" readonly>
						<div class="item-content">
			             	（请按价格格式输入，例：113.35）
			            </div>
					</div>
				...
				<div class="list-item">
					...
					<div class="col-sm-9 item-right">
						<div class="right-item">
		              		<input type="text" class="form-control" name="min" id="min" value="1" placeholder="请输入最小购买量" value="${goodsInfo.goods.items[0].goodsPrice.min}" readonly>
						</div>
		            	<div class="right-item last-item">
	                 		<input type="text" class="form-control" name="max" id="max" placeholder="请输入最大购买量" value="${goodsInfo.goods.items[0].goodsPrice.max}" readonly>
						</div>
						<div class="item-content">
			             	（请按整数格式输入，填0表示不限制数量）
			            </div>
