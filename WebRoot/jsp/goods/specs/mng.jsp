...
<body>
		...
		<section class="content">
	        <div class="box box-primary">
				...
				<ul id="navTab" class="nav nav-tabs">
					<li class="active"><a id="list"  href="${wmsUrl}/admin/goods/specsMng/list.shtml">明细列表</a></li>
					<li><a href="${wmsUrl}/admin/goods/specsMng/toAdd.shtml">新增明细</a></li>
				</ul>
				</div>
				<div class="box-body">
					<div id="page-wrapper">
	...
	<script type="text/javascript">
		$(function(){
			...
			newIframeObject.src = "${wmsUrl}/admin/goods/specsMng/list.shtml";
