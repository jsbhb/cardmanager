...
<table width="100%" border="0">
	...
	<tr><td align="center" width="100%">
		...
		<!--object classid="clsid:CA8A9780-280D-11CF-A24D-444553540000" width="450" height="580" border="0" name="expressPdf"> 
			...
			<embed name="expressPdf" id="expressPdf" width="1000" height="580" type="application/pdf" src="${wmsUrl }/output/${getDay }/${batch}.pdf"/> 
			<!--iframe name="expressPdf" id="expressPdf" src="${wmsUrl }/output/${getDay }/${batch}.pdf" width="450" height="580" frameborder="0"></iframe-->
		    ...
		    <input type="hidden" name="orderIds" id="orderIds" value="${jsoOrderId }"/>
		</DIV>
	</td></tr>
</table>
...
function printExpress(){
	if ((navigator.userAgent.indexOf('MSIE')>=0) || (navigator.userAgent.indexOf('Trident')>=0)) {
	   ...
	   window.open("${wmsUrl }/output/${getDay}/${batch}.pdf", "", "width=750,height=700,resizable=yes,location=no,scrollbars=yes,left=200,top=100");
		...
		var win=window.showModalDialog('${wmsUrl }/output/${getDay}/${batch}.pdf',
			"非IE浏览器打印",
