			...
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li class="active"><i class="fa fa-user-md fa-fw"></i>${sellerName}: 纯单列表(订单数>12)</li>
					</ol>
				</div>
			</div>
			<div class="row">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								<i class="fa fa-bar-chart-o fa-fw"></i>纯单订单列表(订单数>12)
							</h3>
						</div>
...
<script type="text/javascript">
	...
	var options = {
				queryForm : ".query",
				url :  "${wmsUrl}/admin/stockOut/makeOrder/pureOrderList.shtml?sellerInfoId=${sellerInfoId}",
				numPerPage:"10",
				currentPage:"",
				index:"1",
	...
	function print(){
	    ...
	    var orderDetail = valArr.join('--');//转换为逗号隔开的字符串 
		// 计算库位
		$.post('${wmsUrl}/admin/stockOut/makeOrder/pureCalLib.shtml?sellerInfoId=${sellerInfoId}&carrier='+$('#carrier').val(),{"orderDetail":orderDetail,"flag":"0"}, 
		 function(result) {
			if (result.success) {
				...
				if(result.upFloor){
					$.zzComfirm.alertConfirm(result.msg,function(){
						...
						$.post('${wmsUrl}/admin/stockOut/makeOrder/pureCalLib.shtml?sellerInfoId=${sellerInfoId}&carrier='+$('#carrier').val(),{"orderDetail":orderDetail,"flag":"1"}, 
								 function(result) {
									if (result.success) {
