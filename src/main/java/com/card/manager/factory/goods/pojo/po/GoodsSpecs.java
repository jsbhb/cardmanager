package com.card.manager.factory.goods.pojo.po;
...
public class GoodsSpecs {
	...
	private List<ItemSpecsPojo> itemSpecsList;
	...
	public List<ItemSpecsPojo> getItemSpecsList() {
		return itemSpecsList;
	}

	public void setItemSpecsList(List<ItemSpecsPojo> itemSpecsList) {
