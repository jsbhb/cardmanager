...
public class GoodsBaseEntity {
	...
	public GoodsBaseEntity(JSONObject obj) {
		...
		this.incrementTax = obj.getString("incrementTax");
		this.tariff = obj.getString("tariff");
		this.unit = obj.getString("unit");
		this.hscode = obj.getString("hscode");
		this.encode = obj.getString("encode");
		this.firstCatalogId = obj.getString("firstCatalogId");
		this.secondCatalogId = obj.getString("secondCatalogId");
		this.thirdCatalogId = obj.getString("thirdCatalogId");
		this.centerId = obj.getInt("centerId");
