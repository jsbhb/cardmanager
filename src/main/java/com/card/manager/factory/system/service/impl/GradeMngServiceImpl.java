...
public class GradeMngServiceImpl extends AbstractServcerCenterBaseService implements GradeMngService {
	...
	// @Override
	// public PageCallBack dataList(Pagination pagination, Map<String, Object>
	// hashMap, String token) throws Exception {
	//
	...
	// ServerCenterContants.USER_CENTER_GRADE_QUERY_FOR_PAGE, hashMap, token,
	// HttpMethod.POST);
	//
	...
	public void updateShop(ShopEntity shopInfo, StaffEntity staffEntity) throws Exception {
		...
		ResponseEntity<String> goodscenter_result = helper.request(
				URLUtils.get("gateway") + ServerCenterContants.USER_CENTER_MICRO_SHOP_UPDATE, staffEntity.getToken(),
				true, shopInfo, HttpMethod.POST);
