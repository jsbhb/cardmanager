...
public class QrCodeUtil {
    ...
    public static String checkOrCreate (String account, String goodsId, String goodsPath) throws IOException, WriterException {
		...
		String filePath = servletContext.getRealPath("/") + imgPath + account;
