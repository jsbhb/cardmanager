...
//        File logoFile = new File("E://Program Files (x86)//test//logo.png");
//        File QrCodeFile = new File("E://Program Files (x86)//test//code.png");
//        String url = "http://m.cncoopbuy.com/goodsDetail.html?goodsId=2171";
//        String note = "";
