...
public class LogUtil {
	...
	private final static Logger ERPLOG = LoggerFactory.getLogger("ERP_LOG");
	...
	public static void writeErrorLog(String cont, Throwable ex) {
		ERPLOG.error(ERROR_LOG + cont, ex);
	}
	...
	public static void debug(String cont) {
		if (ERPLOG.isDebugEnabled()) {
			ERPLOG.debug(DEBUG_LOG + cont);
		}
	}
}
