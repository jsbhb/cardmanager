...
public class ServerCenterContants {
	...
	public static final String ORDER_CENTER_APPLY_ORDER_BACK_SEND_ORDER = (TOKEN_NOT_NEED ? "/" : "/ordercenter/")
			+ SERVER_CENTER_EDITION + "/order/refundsWithSendOrder/{orderId}";
